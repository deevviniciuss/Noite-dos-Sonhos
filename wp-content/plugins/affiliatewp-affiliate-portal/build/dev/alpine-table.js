window["AFFWP"] = window["AFFWP"] || {}; window["AFFWP"]["portal"] = window["AFFWP"]["portal"] || {}; window["AFFWP"]["portal"]["alpineTable"] =
...
/***/ "./src/alpine-table/alpine-table.js":
/*!******************************************!*\
  !*** ./src/alpine-table/alpine-table.js ***!
  \******************************************/
...
/* harmony import */ var _affiliatewp_portal_sdk__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @affiliatewp-portal/sdk */ "@affiliatewp-portal/sdk");
/* harmony import */ var _affiliatewp_portal_sdk__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_affiliatewp_portal_sdk__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _affiliatewp_portal_dom_helpers__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @affiliatewp-portal/dom-helpers */ "./src/dom-helpers/dom-helpers.js");
/* harmony import */ var _affiliatewp_portal_url_helpers__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @affiliatewp-portal/url-helpers */ "./src/url-helpers/url-helpers.js");
...
var page = Object(_affiliatewp_portal_url_helpers__WEBPACK_IMPORTED_MODULE_6__["getPage"])(window.location.href);
/**
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setOrder: function setOrder(orderby) {
    ...
    var orders = [false, 'asc', 'desc'];

    if (orderby === this.orderby) {
      var currentOrder = orders.findIndex(function (order) {
        return order === _this.order;
      });
      var nextOrder = currentOrder + 1; // If the provided order is invalid, reset the cycle.

      if (-1 === currentOrder || nextOrder === orders.length) {
        this.order = orders[0];
        this.orderby = false; // Otherwise, increment to the next item in the cycle.
      } else {
   ...
   */
  getSortOrder: function getSortOrder(column) {
   ...
   */
  getSchema: function getSchema(column) {
    return this.schema.find(function (item) {
  ...
  urlForPage: function urlForPage(page) {
    ...
    return Object(_affiliatewp_portal_url_helpers__WEBPACK_IMPORTED_MODULE_6__["paginateUrl"])(window.location.href, args);
  },
   ...
   */
  getCell: function getCell(index, column) {
    var cell = '';
    var schemaColumn = this.getSchema(column);
   ...
   */
  getPageObjects: function getPageObjects() {
    /**
     * Pages.
    ...
    var midpoint = Math.round(maxPages / 2, 0);
    /**
     * Start Page.
    ...
    var endPage; // If we're on an early page, start with page 1

    if (this.currentPage - midpoint <= 0) {
      // Set the starting page to 1.
      startPage = 1; // Set the end page to either the number of pages, or if there are a lot of pages, use the max page amount.

      endPage = this.pages >= maxPages ? maxPages : this.pages; // If we're deep in pagination, start with 10 pages earlier than the current page.
    } else {
      // Offset our start page from our midpoint. This puts the current page in the middle of the pages rendered.
      startPage = this.currentPage - midpoint; // Set the end page to the start page plus the total pages. This fills in the pages _after_ the current page.

      endPage = startPage + maxPages; // If there are not many pages left to display, just display what is left.
    ...
    for (var _page = startPage; _page <= endPage; _page++) {
      ...
      var disabled = 1 === _page ? this.currentPage <= 1 : this.currentPage === _page; // Append the page to the list of pages.
   ...
   * @return {void}
   */
  handleOrderEvent: function handleOrderEvent(e, orderby) {
    e.preventDefault();

    if (true === this.allowSorting) {
      Object(_affiliatewp_portal_dom_helpers__WEBPACK_IMPORTED_MODULE_5__["scrollWrapperTo"])(Object(_affiliatewp_portal_dom_helpers__WEBPACK_IMPORTED_MODULE_5__["getContentWrapper"])().scrollleft, 0);
   ...
   * @return {void}
   */
  handlePageEvent: function handlePageEvent(e, page) {
    e.preventDefault();
  ...
  fetchPage: function fetchPage(page) {
    ...
    return new Promise( /*#__PURE__*/function () {
      var _ref = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(res, rej) {
        var data;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return Object(_affiliatewp_portal_sdk__WEBPACK_IMPORTED_MODULE_4__["portalSchemaRows"])(_this2.type, args);

              case 2:
                data = _context.sent;
                _this2.rows = data.rows;
                _this2.pages = data.pages; // If the pagination hasn't been explicitly set, dynamically display it if necessary.

                if (undefined === _this2.showPagination) {
                  _this2.showPagination = data.pages > 1;
                }

                _this2.currentPage = page;
                _this2.previousPage = _this2.previousPage > 0 ? _this2.previousPage : page;
                _this2.nextPage = _this2.nextPage > _this2.pages ? page : _this2.nextPage;
                _this2.isLoading = false;

                _this2.updateUrl(args, skipHistory);
   ...
   * @return {void}
   */
  updateUrl: function updateUrl(args) {
    var skipHistory = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
    ...
    if (false === skipHistory && false !== this.showPagination && undefined !== this.showPagination) {
      window.history.pushState(undefined, document.title, Object(_affiliatewp_portal_url_helpers__WEBPACK_IMPORTED_MODULE_6__["paginateUrl"])(window.location.href, args));
    }
  },
      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              currentPage = Object(_affiliatewp_portal_url_helpers__WEBPACK_IMPORTED_MODULE_6__["getPage"])(window.location.href);

              if (false === _this3.order && Object(_wordpress_url__WEBPACK_IMPORTED_MODULE_3__["hasQueryArg"])(window.location.href, 'order')) {
                _this3.order = Object(_wordpress_url__WEBPACK_IMPORTED_MODULE_3__["getQueryArg"])(window.location.href, 'order');
              }

              if (false === _this3.orderby && Object(_wordpress_url__WEBPACK_IMPORTED_MODULE_3__["hasQueryArg"])(window.location.href, 'orderby')) {
                _this3.orderby = Object(_wordpress_url__WEBPACK_IMPORTED_MODULE_3__["getQueryArg"])(window.location.href, 'orderby');
              }

              _context2.next = 5;
              return _this3.fetchPage(currentPage, true);
...
/***/ "./src/dom-helpers/dom-helpers.js":
/*!****************************************!*\
  !*** ./src/dom-helpers/dom-helpers.js ***!
  \****************************************/
/*! exports provided: getContentWrapper, scrollWrapperTo */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getContentWrapper", function() { return getContentWrapper; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "scrollWrapperTo", function() { return scrollWrapperTo; });
/**
...
/*!**************************************************!*\
  !*** external {"this":["AFFWP","portal","sdk"]} ***!
  \**************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

(function() { module.exports = this["AFFWP"]["portal"]["sdk"]; }());
