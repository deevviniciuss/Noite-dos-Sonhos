...
function settings() {
  return {
     ...
     * Current notices.
     *
     * HTML string with list of notices to show to the affiliate.
     *
     * @since  1.0.0
     * @access public
     *
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                ...
                _this.notices = response.notices; // Add one default domain if no links saved.
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 5:
                ...
                _this3.notices = response.notices;
