window["AFFWP"] = window["AFFWP"] || {}; window["AFFWP"]["portal"] = window["AFFWP"]["portal"] || {}; window["AFFWP"]["portal"]["urlGenerator"] =
...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/url-generator/index.js");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony import */ var _affiliatewp_portal_sdk__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @affiliatewp-portal/sdk */ "@affiliatewp-portal/sdk");
/* harmony import */ var _affiliatewp_portal_sdk__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_affiliatewp_portal_sdk__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var _affiliatewp_portal_helpers__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @affiliatewp-portal/helpers */ "./src/helpers/helpers.js");
/* harmony import */ var _affiliatewp_portal_clipboard_helpers__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @affiliatewp-portal/clipboard-helpers */ "./src/clipboard-helpers/clipboard-helpers.js");
/* harmony import */ var _affiliatewp_portal_url_helpers__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @affiliatewp-portal/url-helpers */ "./src/url-helpers/url-helpers.js");
...
function urlGenerator() {
  return {
     ...
     * @type string
     */
    defaultCopyMessage: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__["__"])('Copy link', 'affiliatewp-affiliate-portal'),
     ...
     * @type string
     */
    defaultErrorMessage: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__["__"])('Invalid URL', 'affiliatewp-affiliate-portal'),
     ...
     */
    set urls(value) {
      AFFWP.portal.core.store.set('urlGeneratorUrls', _objectSpread(_objectSpread({}, this.urls), value));
    },
     ...
     */
    generateUrl: function generateUrl(type) {
      var urlObject = this.getUrlObject(type); // If the URL is not set, return empty string for now.
      ...
      var args = {}; // If we have a campaign, use it.
      ...
      if (true === this.prettyAffiliateUrls) {
        inputUrl = Object(_affiliatewp_portal_url_helpers__WEBPACK_IMPORTED_MODULE_10__["appendUrl"])(inputUrl, "".concat(this.referralVar, "/").concat(this.referralFormatValue)); // Otherwise, set the referral var to the affiliate ID.
      } else {
        args[this.referralVar] = this.referralFormatValue;
      } // Re-encode the URL. Decode it first, just in-case it came in already-encoded.


      inputUrl = encodeURI(Object(_wordpress_url__WEBPACK_IMPORTED_MODULE_6__["safeDecodeURI"])(inputUrl)); // Set query paramaters based on generated argus.

      var url = Object(_wordpress_url__WEBPACK_IMPORTED_MODULE_6__["addQueryArgs"])(inputUrl, args); // Re-instantiate the URL object. URL validation happens here.

      var urls = this.urls;
      urls[type] = this.urlObject({
        url: url
      });
      this.urls = urls; // Return the URL param
     ...
     */
    getUrlObject: function getUrlObject(type) {
     ...
     */
    getUrlParam: function getUrlParam(type, param) {
      var object = this.getUrlObject(type);
      /*
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                urlObject = _this.getUrlObject(type); // If the URL Object type could not be found, bail.
              ...
              case 3:
                _context.prev = 3;
                _context.next = 6;
                return Object(_affiliatewp_portal_clipboard_helpers__WEBPACK_IMPORTED_MODULE_9__["copy"])(urlObject.url);

              case 6:
                urlObject.copyMessage = "\uD83C\uDF89 ".concat(Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__["__"])('Copied!', 'affiliatewp-affiliate-portal'));
                _context.next = 12;
                break;
              ...
              case 9:
                ...
                urlObject.copyMessage = Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__["__"])('Could not copy to clipboard', 'affiliatewp-affiliate-portal');

              case 12:
                _context.next = 14;
                return Object(_affiliatewp_portal_helpers__WEBPACK_IMPORTED_MODULE_8__["pause"])(2000);
    ...
    init: function init() {
      ...
      return _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_2___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.mark(function _callee2() {
        var _yield$Promise$all, _yield$Promise$all2, affiliate, settings;
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return Promise.all([Object(_affiliatewp_portal_sdk__WEBPACK_IMPORTED_MODULE_7__["portalAffiliate"])(), Object(_affiliatewp_portal_sdk__WEBPACK_IMPORTED_MODULE_7__["portalSettings"])()]);

              case 2:
                _yield$Promise$all = _context2.sent;
                _yield$Promise$all2 = _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_0___default()(_yield$Promise$all, 2);
                affiliate = _yield$Promise$all2[0];
                settings = _yield$Promise$all2[1];
                // Set object values from fetch'd data.
                _this2.baseAuthority = Object(_wordpress_url__WEBPACK_IMPORTED_MODULE_6__["getAuthority"])(affiliate.base_url);
                _this2.inputUrl = affiliate.base_url;
                _this2.affiliateId = affiliate.affiliate_id;
                _this2.prettyAffiliateUrls = settings.pretty_affiliate_urls;
                _this2.referralFormatValue = settings.referral_format_value;
                _this2.referralVar = settings.referral_var;
                _this2.pageUrlLabel = Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__["__"])("Enter any valid page URL from ".concat(affiliate.base_url), 'affiliatewp-affiliate-portal'); // Set initial URL Objects

                _this2.urls = {
                  generated: _this2.urlObject({
                    url: affiliate.base_url
                  }),
                  referral: _this2.urlObject({
                    url: _this2.getUrlParam('generated', 'url')
                  })
                };
                Object.keys(_this2.urls).forEach(function (url) {
                  _this2.generateUrl(url);
     ...
     */
    urlObject: function urlObject(args) {
      ...
      var result = _objectSpread(_objectSpread({}, {
        ...
        url: ''
      }), args); // Set the copy message, and error status of the URL.


      if (Object(_affiliatewp_portal_url_helpers__WEBPACK_IMPORTED_MODULE_10__["hasValidProtocol"])(result.url) && Object(_affiliatewp_portal_url_helpers__WEBPACK_IMPORTED_MODULE_10__["authoritiesMatch"])(result.url, this.baseAuthority)) {
...
/* harmony default export */ __webpack_exports__["default"] = (urlGenerator);
