		...
		<div class="wrap about-wrap sm">
			<div class="sm_row" id="sm-pricing">
				<div class="sm_main_heading">
					...
					<div style="padding-top: 1em;font-size: 0.5em;"><?php echo __( '* Offer valid only on Annual Plans', 'smart-manager-for-wp-e-commerce' ); ?></div>
				</div>
				<div class="sm_price_column_container">
					...
					<div class="sm_column column_one_fourth pricing sm_lifetime_price scaleup" style="border-color: #252f3fe6;padding: 0;border-width: 0.2em;">
						...
						<span class="sm_price">
							<h2><?php echo __( '$449', 'smart-manager-for-wp-e-commerce' ); ?></h2>
						</span>

						<div class="center">
							<a class="sm_button small green center" href="https://www.storeapps.org/?buy-now=86835&qty=1&page=722&with-cart=1&utm_source=sm&utm_medium=in_app_pricing&utm_campaign=single_lifetime" target="_blank" rel="noopener"><?php _e( 'Buy Now', 'smart-manager-for-wp-e-commerce' ); ?><span style="width: 1em; height: 1em; background-image: url('https://www.storeapps.org/wp-content/themes/storeapps/assets/images/fidget.svg'); display: inline-block; margin-left: 0.5em" class="fidget spin"></span></a>
						</div>
					</div>
					<div class="sm_column column_one_fourth pricing sm_last sm_lifetime_price">
						...
						<span class="sm_price">
							<h2 style="margin-top: 1.25em !important"><?php echo __( '$479', 'smart-manager-for-wp-e-commerce' ); ?></h2>
						</span>

						<div class="center">
							<a class="sm_button small green center" href="https://www.storeapps.org/?buy-now=86836&qty=1&page=722&with-cart=1&utm_source=sm&utm_medium=in_app_pricing&utm_campaign=multi_lifetime" target="_blank" rel="noopener"><?php _e( 'Buy Now', 'smart-manager-for-wp-e-commerce' ); ?></a>
						</div>
					</div>
				</div>
			</div>
			<div class="sm_row" id="sm-testimonial">
				...
				<div class="sm_column" id="sm-jeff-testimonial">
					<img src="<?php echo SM_IMG_URL ?>jeff-smith.png" alt="Jeff" />
			...
			<div class="sm_row" id="sm_product_page_link">
				<?php echo sprintf( __( 'Want to know more about Smart Manager Pro? %s.', 'smart-manager-for-wp-e-commerce' ), '<a style="color: #5850ec;" target="_blank" href="https://www.storeapps.org/product/smart-manager/?utm_source=sm&utm_medium=in_app_pricing&utm_campaign=sm_know">' . __( 'Click here', 'smart-manager-for-wp-e-commerce' ) . '</a>' ); ?>
			</div>
		</div>
		<?php
	}
